 ...
 *
 * @property Members|null $user This property is read-only.
 *
 */
class LoginForm extends Model
{
    ...
    public function validatePassword($attribute, $params)
    {
        if (!$this->hasErrors()) {
            ...
            $usrWithoutStatus=Members::findByEmailWithoutStatus($this->email);
    ...
    {
        if ($this->_user === false) {
            $this->_user = Members::findByEmail($this->email);
        }
