...
<section class="header-board pp">
    <div class="container">
        <div class="header-board__top">
            <h1 class="title">My Workout Plan</h1>
        </div>
            ...
            <div class="col-12 col-md-12 col-sm-12 col-lg-12">
                <?php if ($myPlans) { ?>
                    ...
                    <div class="row work_plan">
                        <? foreach ($myPlans as $model){ ?>
                            <div class="col-12 col-md-8 col-sm-8 mb-3 col-lg-5">
                                <?=$this->render('../elements/my-workout-list-item',['model'=>$model->plan])?>
                            </div>
                        <? } ?>
                    </div>
                <?php } else { ?>
                ...
                <?php if($otherPlans){ ?>
                    ...
                    <p class="text text__width mb-4">
                        Note: Your current plan allows you to change workout programs a maximum of one time monthly.
                    ...
                    <div class=" owl-carousel slide-three">
                        <? foreach ($otherPlans as $model){ ?>
                            <div class="some_col">
                                <?=$this->render('../elements/workout-list-item',['model'=>$model,'changePopup'=>true])?>
                            </div>
                        <? } ?>
                    </div>
                <?php } ?>
