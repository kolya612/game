...
<!-- Modal -->
<div class="modal fade in" id="workout_popup_<?=$id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <a href="<?=\yii\helpers\Url::to(['/shop/workout-to-cart','id'=>$model->id])?>" class="btn btn-primary  w-100">Buy Now</a>
                <? if($lastFreeWorkout){ ?>

                <? }else{ ?>
                    <button onclick="$('#workout_popup_<?=$id?>').modal('hide');$('#confirm_workout_popup_<?=$id?>').modal('show');return false;" type="button" class="btn btn-secondary w-100" data-dismiss="modal">Switch Plan</button>
                <? } ?>
            </div>
        </div>
    </div>
...
<!-- Modal -->
<div class="modal fade in" id="confirm_workout_popup_<?=$id?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-footer">
                <a href="<?=\yii\helpers\Url::to(['/workout-plan/switch','id'=>$model->id])?>" class="btn btn-primary  w-100">Switch Plan</a>
