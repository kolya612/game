        ...
        init: function (c) {
            return this.each(function () {
                    ...
                    if (!k.skip && !k.complete && !k.uploading) {
                        ...
                        if (typeof FormData === "function" || typeof FormData === "object") {
                            ...
                            xhr.addEventListener("load", function (n) {
                                ...
                                $('#image_download_error').append(this.response);
                                setTimeout(function(){
                                    $('#image_download_error').html('');
                                },5000);
                ...
                d.error = function (l, j, k) {
                    if (b.inArray("onError", f.overrideEvents) < 0) {
                        switch (l) {
                            case"ERROR": // added custom error
                                errorMsg = j.xhr.statusText;
                                break;
                ...
                if (window.File && window.FileList && window.Blob && (window.FileReader || window.FormData)) {
                    ...
                    d.button = b('<div id="' + f.id + '" class="uploadifive-button">'+(f.buttonText1?'<h4 class="title">'+f.buttonText1+'</h4>':'')+'<i class="plus-button"></i>'+(f.buttonText2?'<p class="text">'+f.buttonText2+'</p>':'')+f.buttonText + "</div>");
                    if (f.buttonClass) {
            ...
            this.each(function () {
                ...
                if (c) {
                    ...
                    if ((e.uploads.count + e.uploads.current) < f.uploadLimit || f.uploadLimit == 0) {
                        ...
                        if (b("#" + f.queueID).find(".uploadifive-queue-item").not(".error, .complete").length == 0) {
                            e.queueComplete();
                        }
                    } else {
