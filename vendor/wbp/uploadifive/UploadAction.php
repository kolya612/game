...
class UploadAction extends \yii\base\Action {
    ...
    public function getUpladedFileName(){
        return $this->_uploadFileInstance->name;
    }
    ...
    public function run() {
        try {
            ...
            file_put_contents(Yii::getAlias('@serverDocumentRoot/images').'/uplodifyErrorLog',$e->getMessage());
            return $e->getMessage();
        }
    }
    ...
    private function getSaveFileName() {
        ...
        //替换随机字符串
        $randNum = rand(1, 10000000) . rand(1, 1000000);
        $matches = [];
