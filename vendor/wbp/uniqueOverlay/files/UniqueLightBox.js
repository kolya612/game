...
function centeruniqueOverlay(time){
    $('.UniqueLightbox').height('auto');
    $('.UniqueLightbox').width('auto');
    $('.UniqueLightbox').removeClass('fit-page');
    if($('.UniqueLightbox').height()>$(window).height()){
        $('.UniqueLightbox').height($(window).height());
        $('.UniqueLightbox').addClass('fit-page');
    }
    if($('.UniqueLightbox').width()>$(window).width()){
        $('.UniqueLightbox').width($(window).width());
    }
    var top=($(window).height()-$('.UniqueLightbox').height())/2;
    if(top<0) top=0;
    if(time > 0){
