        ...
        <div class="topbar">
            ...
            <div class="dropdown">
                ...
                <div class="dropdown-menu p-0 m-0 dropdown-menu-right dropdown-menu-anim-up dropdown-menu-lg">
                    <!--begin:Header-->
                    <div class="d-flex flex-column flex-center py-10 bgi-size-cover bgi-no-repeat rounded-top" style="background-image: url(<?=$bundle->baseUrl?>/media/misc/bg-1.jpg)">
            ...
            <div class="dropdown">
                ...
                <div class="topbar-item" data-toggle="dropdown" data-offset="10px,0px">
                    <div class="btn btn-icon btn-clean btn-dropdown btn-lg mr-1">
                        <img class="h-20px w-20px rounded-sm" src="<?=$bundle->baseUrl?>/media/svg/flags/226-united-states.svg" alt="" />
                    </div>
                </div>
                <!--end::Toggle-->
                <!--begin::Dropdown-->
                        ...
                        <li class="navi-item">
                            <a href="" class="navi-link">
                                <span class="symbol symbol-20 mr-3">
                                    <img src="<?=$bundle->baseUrl?>/media/svg/flags/226-united-states.svg" alt="" />
                                </span>
            ...
            <div class="topbar-item">
                <div class="btn btn-icon btn-icon-mobile w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                    ...
                    <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?=Yii::$app->user->identity->getName()?></span>
                    <span class="symbol symbol-lg-35 symbol-25 symbol-light-success">
                        <span class="symbol-label font-size-h5 font-weight-bold"><?=strtoupper(Yii::$app->user->identity->getName()[0])?></span>
                    </span>
                </div>
            </div>
            <!--end::User-->
