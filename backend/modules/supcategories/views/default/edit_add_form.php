...
/* @var $model backend\modules\supcategories\models\Supcategories */
...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    <div class="card-body">
        ...
        <div class="row">
            ...
            <div class="col-xl-10">
                <div class="my-5">
                    <h3 class=" text-dark font-weight-bold mb-10">The Category for supplement</h3>
                    <div class="row">
                        <div class="col-xl-7">
                            <?= $form->field($formModel, 'sort',[
                                'template' => '<label class="control-form-label col-xl-3">Sort Order:</label><div class="col-xl-9">{input}</div>',
                            ])
                                ->textInput(['maxlength' => true, 'class' => 'form-control form-control-solid', 'style' => 'width:100px;'])
                                ->label(false)
                            ?>
                            <?= $form->field($formModel, 'title',[
                                'template' => '<label class="control-form-label col-xl-3">Title:</label><div class="col-xl-9">{input}</div>',
                            ])
                        ...
                        <div class="col-xl-4" style="background-color: #eeeeee">
                            <div class="image-input image-input-outline" id="kt_image_1">
                                ...
                                echo \wbp\imageUploader\ImageUploader::widget([
                                    ...
                                    'data' => ['size' => '123x123'],
                                    'type' => Supcategories::$imageTypes[0],
