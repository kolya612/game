...
/* @var $model backend\modules\meals\models\Meals */
...
-->
                        ...
                        <div class="col-xl-11">
                            <?=$form
                                ->field($formModel,'mecategoriesIds',[])
                                ->dropDownList(\backend\modules\mecategories\models\Mecategories::getList('id', 'title','id desc'),[
                                    'multiple'=>'multiple',
                                    'class' => 'form-control form-control-solid',
...
<div class="card card-custom card-sticky" id="kt_page_sticky_card">
    <div class="card-body">
        <div class="row">
            ...
            <div class="col-xl-5">
                <div class="my-5">
                    <h3 class=" text-dark font-weight-bold mb-10">PDF File</h3>
                    <div class="card">
                        <div class="card-body">
                            <?php
