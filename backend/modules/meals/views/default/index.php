...
/* @var $searchModel backend\modules\meals\models\SearchModel */
                    ...
                    'layout' => '<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">                                        
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>#</th>
                                                    <th>Title</th>
                                                    <th style="width: 150px; text-align: center;">Phase</th>
                                                    <th style="width: 150px; text-align: center;">Price</th>
                                                    <th style="width: 150px; text-align: center;">Sale price</th>
