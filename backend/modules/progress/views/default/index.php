...
/* @var $searchModel backend\modules\progress\models\SearchModel */
                    ...
                    'layout' => '<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">                                        
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>#</th>
                                                    <th>Members</th>
                                                    <th style="text-align: center;" class="center">Photo</th>
                                                    <th style="width: 10%; text-align: center;" class="center">WEIGHT</th>
                                                    <th style="width: 10%; text-align: center;" class="center">FAT</th>
                                                    <th style="width: 10%; text-align: center;" class="center">DATE</th>
