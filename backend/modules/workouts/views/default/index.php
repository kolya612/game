...
/* @var $searchModel backend\modules\workouts\models\SearchModel */
                    ...
                    'layout' => '<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">                                        
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>#</th>
                                                    <th>Title</th>
                                                    <th style="width: 10%; text-align: center;" class="center">PLAСE</th>
                                                    <th style="width: 10%; text-align: center;" class="center">PHASE</th>
                                                    <th style="width: 10%; text-align: center;" class="center">STATUS</th>
