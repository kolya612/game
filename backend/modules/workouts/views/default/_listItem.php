        ...
        <span style="width: 250px;">
            <div class="d-flex align-items-center">
                ...
                <div class="ml-3">
                    ...
                    <a href="#" class="text-muted font-weight-bold text-hover-primary"><?=\common\models\Data::GOAL[$model->goal]?> for <?=\common\models\Data::GENDER[$model->gender]?></a>
                </div>
            </div>
        </span>
    </td>
    <td style="width: 10%; text-align: center;" class="center">
        <?=\common\models\Data::WORKOUT_OFTEN[$model->workout_often]?>
    </td>
    <td style="width: 10%; text-align: center;" class="center">
        <?=\common\models\Data::PHASE[$model->phase]?>
    </td>
    <td style="width: 10%; text-align: center;" class="center">
        <?=\common\models\Data::STATUS[$model->status]?>
    </td>
