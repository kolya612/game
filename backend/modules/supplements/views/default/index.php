...
/* @var $searchModel backend\modules\supplements\models\SearchModel */
                    ...
                    'layout' => '<table class="table table-separate table-head-custom table-checkable" id="kt_datatable">                                        
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th>Title</th>
                                                    <th>SupCategories</th>
                                                    <th style="width: 10%; text-align: center;" class="center">Price</th>
                                                    <th style="width: 10%; text-align: center;" class="center">Sale price</th>
